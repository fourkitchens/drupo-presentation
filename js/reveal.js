...
var Reveal = (function(){
  ...
  function onDocumentKeyDown( event ) {
    ...
    // ETF: Lifted from Paul Irish's slidedeck to rotate links.
    var carousel = Carousel3D.getCurrent();
    if (carousel && (event.keyCode == 37 || event.keyCode == 39)) {
      event.keyCode == 39 ? Carousel3D.moveCurrentNext() : Carousel3D.moveCurrentPrevious();
      return;
    }
